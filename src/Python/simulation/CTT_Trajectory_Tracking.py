...
pub_msg.header.frame_id = 'CTT_trajectory_control'
...
while True:
    ...
    V_AV, cs_steer = CTT.calculate_stanley_control_traj(X_pos_t, Y_pos_t, yaw, t_now, rot_x, rot_y, dt_tr, V_curv, yaw_wp)
