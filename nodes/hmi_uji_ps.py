...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_ps.setGeometry(QtCore.QRect(380, 90, 241, 71))
        font = QtGui.QFont()
        ...
        self.button_path.setGeometry(QtCore.QRect(640, 90, 241, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.button_doc.setGeometry(QtCore.QRect(380, 190, 241, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.button_doc.setFont(font)
        self.button_doc.setObjectName("button_doc")
        self.button_doc.clicked.connect(self.mode5)

        # -------------------------- Push Button undoc ------------------------------------
        self.button_undoc = QtWidgets.QPushButton(self.centralwidget)
        self.button_undoc.setGeometry(QtCore.QRect(640, 190, 241, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.button_undoc.setFont(font)
        self.button_undoc.setObjectName("button_undoc")
        self.button_undoc.clicked.connect(self.mode_undocking)

        # -------------------------- Push Button Lift up ------------------------------------
        self.button_liftUp = QtWidgets.QPushButton(self.centralwidget)
        self.button_liftUp.setGeometry(QtCore.QRect(380, 290, 241, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.button_liftUp.setFont(font)
        self.button_liftUp.setObjectName("button_liftUp")
        self.button_liftUp.clicked.connect(self.mode_liftUp)

        # -------------------------- Push Button Lift Mid ------------------------------------
        self.button_liftMid = QtWidgets.QPushButton(self.centralwidget)
        self.button_liftMid.setGeometry(QtCore.QRect(380, 390, 241, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.button_liftMid.setFont(font)
        self.button_liftMid.setObjectName("button_liftMid")
        self.button_liftMid.clicked.connect(self.mode_liftMid)

        # -------------------------- Push Button Lift Down ------------------------------------
        self.button_liftDown = QtWidgets.QPushButton(self.centralwidget)
        self.button_liftDown.setGeometry(QtCore.QRect(380, 490, 241, 71))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.button_liftDown.setFont(font)
        self.button_liftDown.setObjectName("button_liftDown")
        self.button_liftDown.clicked.connect(self.mode_liftDown)
        
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(450, 20, 290, 80))
    ...
    def callback_data_conv(self, msg):
        ...
        elif self.mode_auto == 10: self.mode_liftMid()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_doc.setText(_translate("MainWindow", "DOCKING"))
        self.button_undoc.setText(_translate("MainWindow", "UNDOCKING"))
        self.button_liftUp.setText(_translate("MainWindow", "LIFT UP"))
        self.button_liftMid.setText(_translate("MainWindow", "LIFT MID"))
        self.button_liftDown.setText(_translate("MainWindow", "LIFT DOWN"))        
