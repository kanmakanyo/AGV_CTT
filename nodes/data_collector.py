...
idc_lamp = 0
ultra1, ultra2, ultra3, ultra4, ultra5, ultra6, ultra7, ultra8, ultra4_4 = 0, 0, 0, 0, 0, 0, 0, 0, 0
...
def callback_utrasonik(msg):
    global ultra1, ultra2, ultra3, ultra4, ultra5, ultra6, ultra7, ultra8, ultra4_4
...
while not rospy.is_shutdown():
    ...
    pub_msg.covariance[14]= ultra4_4
...
#     client = connect_mqtt()
#     client.loop_start()
#     callback_controlAlgorithm(client)
#     callback_dataConv(client)
#     callback_dbw_pubsub(client)
#     callback_utrasonik(client)
#     callback_lidar(client)
