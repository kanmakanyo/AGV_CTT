...
while not rospy.is_shutdown():
    ...
    print(len(lis))
    ECV2J18_PID = int(lis[68])*10000 + int(lis[69])*1000 + int(lis[70])*100 + int(lis[71])*10 + int(lis[72])
    # ZC5 = int(lis[74])*10000 + int(lis[75])*1000 + int(lis[76])*100 + int(lis[77])*10 + int(lis[78])
    # print(f"ZC5 : {ZC5}")
    # ECVDARE24_PID = int(lis[79])*10000 + int(lis[80])*1000 + int(lis[81])*100 + int(lis[82])*10 + int(lis[83])
    # print(f"ECVDARE24 : {ECVDARE24_PID}")
    # SQ1 = int(lis[84])
    # print(f"SQ1 : {SQ1}")
    # SQ2 = int(lis[85])
    # print(f"SQ2 : {SQ2}")
    # ESVDAR_ENA = int(lis[86])
    # print(f"ESVDAR_ENA : {ESVDAR_ENA}")
    ...
    # 39        : Rear Steering Enabler (ECVDAR_E24)
    ...
    # ESVDAR_ENA_SIG (Rear Steering ENA)
    ESVDAR_ENA_target = list(str(ESVDAR_ENA_SIG))[0]
    # ESVI_SIG 
    ...
    sendplc = str("@") + ZC2_target + ESV1415_ENA_target + ECV2J19_ENA_target + speed_target + \
        YS3_1_SIG_target + YS3_2_SIG_target + ESVDLAR_ENA_SIG_target + ECVLAR_ENA_SIG_target + \
            ...
            ZC5_target + ESVDAR_ENA_target +  ESVI_target + ESVD_target
    ...
    #========New===============
    pub_msg.pose.covariance[30]
    pub_msg.pose.covariance[31]
